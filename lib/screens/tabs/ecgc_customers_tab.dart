...
class EcgcCustomersTab extends StatefulWidget {
  ...
  const EcgcCustomersTab({
    super.key,
    this.category = 'ECGC',
    this.title = 'ECGC Customers',
    this.currentUser,
  ...
  @override
  State<EcgcCustomersTab> createState() => _EcgcCustomersTabState();
}

class _EcgcCustomersTabState extends State<EcgcCustomersTab> {
  // ── palette ────────────────────────────────────────────────────────────────
  ...
  Future<void> _openLinkPolicyDialog(
    ...
    int? selectedEcgcSlabIndex;
    Map<String, dynamic>? selectedEcgcSlab;
    ...
    List<Map<String, dynamic>> generalSlabsForPolicy(
      ...
      final groups = policy['ecgcCommissions'];
          ...
          builder: (ctx, setS) {
            ...
            void recomputeCommission() {
              ...
              if (category == 'general') {
                setS(
                  () =>
                      commissionPercent = generalSlabPercent(selectedEcgcSlab),
                );
                return;
              }
              if (category == 'health') {
            ...
            Future<void> saveLink() async {
              ...
              try {
                ...
                final policyFields = {
                  ...
                  'selectedSlabIndex': selectedEcgcSlabIndex,
                  'selectedSlabLabel': generalSlabLabel(selectedEcgcSlab),
                  'selectedSlabPercent': generalSlabPercent(selectedEcgcSlab),
                  'selectedSlabNotes':
                      selectedEcgcSlab?['notes']?.toString() ?? '',
                  'selectedEcgcSlab': selectedEcgcSlab,
                        ...
                        DropdownButtonFormField<String>(
                          ...
                          onChanged: (v) {
                            ...
                            setS(() {
                              ...
                              selectedEcgcSlabIndex = null;
                              selectedEcgcSlab = null;
                                    ...
                                    child: Container(
                                      ...
                                      child: Row(
                                        children: [
                                          Radio<int>(
                                            value: index,
                                            groupValue: selectedEcgcSlabIndex,
                                            activeColor: _accent,
                                            onChanged: (v) {
                                              if (v == null) return;
                                              setS(() {
                                                selectedEcgcSlabIndex = v;
                                                selectedEcgcSlab = slab;
                                                commissionPercent = percent;
                                              });
                                            },
