          ...
          body: StreamBuilder<QuerySnapshot<Map<String, dynamic>>>(
            ...
            builder: (context, snap) {
              ...
              return GridView.builder(
                ...
                itemBuilder: (context, i) => _PolicyGridCard(
                  doc: docs[i],
                  serialNumber: i + 1,
...
class _PolicyGridCard extends StatefulWidget {
  final QueryDocumentSnapshot<Map<String, dynamic>> doc;
  final int serialNumber;
  final VoidCallback onTap;

  const _PolicyGridCard({
    required this.doc,
  ...
  @override
  State<_PolicyGridCard> createState() => _PolicyGridCardState();
}

class _PolicyGridCardState extends State<_PolicyGridCard> {
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            ...
                            if (category.isNotEmpty && policyCode.isNotEmpty)
                              const SizedBox(width: 6),
