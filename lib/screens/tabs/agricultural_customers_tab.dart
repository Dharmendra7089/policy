// ignore_for_file: unused_element, unnecessary_underscores, no_leading_underscores_for_local_identifiers, deprecated_member_use, curly_braces_in_flow_control_structures, use_null_aware_elements
...
class AgriculturalCustomersTab extends StatefulWidget {
  ...
  const AgriculturalCustomersTab({
    super.key,
    this.category = 'Agricultural',
    this.title = 'Agricultural Customers',
    this.currentUser,
  ...
  @override
  State<AgriculturalCustomersTab> createState() =>
      _AgriculturalCustomersTabState();
}

class _AgriculturalCustomersTabState extends State<AgriculturalCustomersTab> {
  // ── palette ────────────────────────────────────────────────────────────────
                              ...
                              Expanded(
                                child: ListView.separated(
                                  ...
                                  itemBuilder: (_, i) {
                                    ...
                                    return _CustomerRow(
                                      doc: customer,
                                      linkedPolicy: linkedPolicies.isEmpty
                                          ? null
              ...
              try {
                ...
                if (isEdit) {
                  ...
                  await AuditLogService.write(
                    page: '${widget.category} Customers',
                  ...
                  data['createdBy'] = uid;
                  data['customerCategory'] = widget.category;
  ...
  Future<Map<String, String>?> _extractPdfFields(
    ...
    try {
      ...
      if (text.trim().isNotEmpty) {
        final fields = _parseSbiHealthProposal(text);
  ...
  Future<void> _openLinkPolicyDialog(
    ...
    final allPolicies = uniquePolicies.values.toList()
      ..removeWhere(
        (policy) =>
            (policy['category'] ?? widget.category).toString().toLowerCase() !=
    ...
    final policyTermCtrl = TextEditingController();
    ...
    int? selectedAgriculturalSlabIndex;
    Map<String, dynamic>? selectedAgriculturalSlab;
    ...
    List<Map<String, dynamic>> generalSlabsForPolicy(
      ...
      for (final group in groups) {
        ...
        for (final rawSlab in slabs) {
          if (rawSlab is Map) {
            result.add(Map<String, dynamic>.from(rawSlab));
          }
        }
      }
      return result;
    ...
    double generalSlabPercent(Map<String, dynamic>? slab) {
      if (slab == null) return 0;
      final v = slab['percent'];
      if (v is num) return v.toDouble();
      return double.tryParse((v ?? '').toString()) ?? 0;
    }

    String generalSlabLabel(Map<String, dynamic>? slab) {
      if (slab == null) return '';
      return (slab['label'] ?? '').toString();
    }
        ...
        return StatefulBuilder(
          builder: (ctx, setS) {
            ...
            void recomputeCommission() {
              ...
              if (category == 'general') {
                setS(
                  () => commissionPercent = generalSlabPercent(
                    selectedAgriculturalSlab,
                  ),
                );
                return;
              }
              ...
              setS(() {
                ...
                if (selectedPolicyId == null) {
                  ...
                  for (final p in allPolicies) {
                    final planMatch =
                        pdfPlan.isNotEmpty &&
                        (p['planName'] ?? '').toString().toLowerCase().contains(
                          pdfPlan,
                        );
                    final compMatch =
            ...
            Future<void> saveLink() async {
              ...
              if (selectedAgriculturalSlab == null) {
                messenger.showSnackBar(
                  const SnackBar(
                    content: Text('Please select a payout slab'),
                    backgroundColor: Colors.red,
                  ),
                );
                return;
              ...
              try {
                ...
                final policyFields = {
                  ...
                  'selectedSlabIndex': selectedAgriculturalSlabIndex,
                  'selectedSlabLabel': generalSlabLabel(
                    selectedAgriculturalSlab,
                  ),
                  'selectedSlabPercent': generalSlabPercent(
                    selectedAgriculturalSlab,
                  ),
                  'selectedSlabNotes':
                      selectedAgriculturalSlab?['notes']?.toString() ?? '',
                  'selectedAgriculturalSlab': selectedAgriculturalSlab,
                  ...
                  'policyTerm': policyTermCtrl.text.trim(),
                  ...
                  child: Column(
                    ...
                    children: [
                          ...
                          children: [
                            Row(
                              children: [
                                ...
                                const Expanded(
                                  child: Text(
                                    'Upload Proposal PDF — auto-fill fields',
                                    style: TextStyle(
                                      color: _accent,
                                      fontSize: 13,
                                      fontWeight: FontWeight.w700,
                        ...
                        DropdownButtonFormField<String>(
                          ...
                          onChanged: (v) {
                            ...
                            setS(() {
                              ...
                              selectedAgriculturalSlabIndex = null;
                              selectedAgriculturalSlab = null;
                      ...
                      if (selectedPolicy != null) ...[
                        _sectionLabel('Select Company Payout Slab *'),
                        Builder(
                          builder: (_) {
                            final slabs = generalSlabsForPolicy(selectedPolicy);
                            if (slabs.isEmpty) {
                              return Container(
                                width: double.infinity,
                                padding: const EdgeInsets.all(12),
                                ...
                                child: const Text(
                                  'No payout slabs configured for this company policy.',
                                  style: TextStyle(
                                    color: _red,
                                    fontSize: 12,
                                    fontWeight: FontWeight.w600,
                            ...
                            return Container(
                              ...
                              child: Column(
                                children: slabs.asMap().entries.map((entry) {
                                  final index = entry.key;
                                  final slab = entry.value;
                                  final label = (slab['label'] ?? '')
                                      .toString();
                                  final notes = (slab['notes'] ?? '')
                                      .toString();
                                  final percent = generalSlabPercent(slab);
                                  final selected =
                                      selectedAgriculturalSlabIndex == index;
                                  final percentText =
                                      percent == percent.truncateToDouble()
                      ...
                      _row2(
                        ...
                        _tf('Policy Term', policyTermCtrl),
                      ),
                      _row2(
                        TextField(
...
class _CustomerRow extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final company = linkedPolicy?['companyName']?.toString() ?? '';
    final policyNumber = linkedPolicy?['policyNumber']?.toString() ?? '';
    final policyAddedBy =
        (linkedPolicy?['createdByName'] ??
                linkedPolicy?['createdByEmail'] ??
                linkedPolicy?['employeeName'] ??
                linkedPolicy?['createdBy'] ??
                '')
            .toString();
    final month = linkedPolicy?['month']?.toString() ?? '';
