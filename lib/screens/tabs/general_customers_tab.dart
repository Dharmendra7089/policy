// ignore_for_file: unused_element, unnecessary_underscores, no_leading_underscores_for_local_identifiers, deprecated_member_use, curly_braces_in_flow_control_structures
...
class GeneralCustomersTab extends StatefulWidget {
  ...
  const GeneralCustomersTab({
    super.key,
    this.category = 'General',
    this.title = 'General Customers',
    this.currentUser,
  ...
  @override
  State<GeneralCustomersTab> createState() => _GeneralCustomersTabState();
}

class _GeneralCustomersTabState extends State<GeneralCustomersTab> {
  // ── palette ────────────────────────────────────────────────────────────────
  ...
  Future<void> _openLinkPolicyDialog(
    ...
    final allPolicies = uniquePolicies.values.toList()
      ..removeWhere(
        (policy) =>
            (policy['category'] ?? 'General').toString().toLowerCase() !=
    ...
    int? selectedGeneralSlabIndex;
    Map<String, dynamic>? selectedGeneralSlab;
    ...
    List<Map<String, dynamic>> generalSlabsForPolicy(
      ...
      final groups = policy['generalCommissions'];
              ...
              if (category == 'general') {
                setS(
                  () => setCommissionPercentValue(
                    generalSlabPercent(selectedGeneralSlab),
                  ),
                );
                return;
              }
            ...
            Future<void> saveLink() async {
              ...
              try {
                ...
                final policyFields = {
                  ...
                  'selectedSlabIndex': selectedGeneralSlabIndex,
                  'selectedSlabLabel': generalSlabLabel(selectedGeneralSlab),
                  'selectedSlabPercent': generalSlabPercent(
                    selectedGeneralSlab,
                  ),
                  'selectedSlabNotes':
                      selectedGeneralSlab?['notes']?.toString() ?? '',
                  'selectedGeneralSlab': selectedGeneralSlab,
                        ...
                        DropdownButtonFormField<String>(
                          ...
                          onChanged: (v) {
                            ...
                            setS(() {
                              ...
                              selectedGeneralSlabIndex = null;
                              selectedGeneralSlab = null;
                            ...
                            return Container(
                              ...
                              child: Column(
                                children: slabs.asMap().entries.map((entry) {
                                  ...
                                  final selected =
                                      selectedGeneralSlabIndex == index;
                                  final percentText =
                                      ...
                                      child: Row(
                                        children: [
                                          Radio<int>(
                                            value: index,
                                            groupValue:
                                                selectedGeneralSlabIndex,
                                            activeColor: _accent,
                                            onChanged: (v) {
                                              if (v == null) return;
                                              setS(() {
                                                selectedGeneralSlabIndex = v;
                                                selectedGeneralSlab = slab;
                                                commissionPercent = percent;
                                              });
                                            },
