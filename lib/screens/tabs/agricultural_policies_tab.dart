...
class AgriculturalPoliciesTab extends StatefulWidget {
  final String category;
  final String title;
  final String? initialSection;

  const AgriculturalPoliciesTab({
    super.key,
    this.category = 'Agricultural',
    this.title = 'Agricultural Insurance',
    this.initialSection,
  });

  @override
  State<AgriculturalPoliciesTab> createState() =>
      _AgriculturalPoliciesTabState();
}

class _AgriculturalPoliciesTabState extends State<AgriculturalPoliciesTab> {
              ...
              child: StreamBuilder<QuerySnapshot<Map<String, dynamic>>>(
                ...
                builder: (context, snap) {
                  ...
                  var docs = (snap.data?.docs ?? [])
                      .where(
                        (d) =>
                            (d.data()['category'] ?? widget.category)
                                .toString() ==
                            widget.category,
                      )
                      .toList();
  ...
  Widget build(BuildContext context) {
    ...
    return InkWell(
      ...
      child: Container(
        padding: const EdgeInsets.all(16),
        decoration: BoxDecoration(
          color: _AgriculturalPoliciesTabState._surface,
          borderRadius: BorderRadius.circular(10),
          border: Border.all(color: _AgriculturalPoliciesTabState._border),
        ),
        child: Row(
          children: [
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  Text(
                    (data['planName'] ?? 'Agricultural Policy').toString(),
                    style: const TextStyle(
                      color: _AgriculturalPoliciesTabState._textMain,
                      fontSize: 14,
                      fontWeight: FontWeight.w800,
                    ),
                  ),
                  ...
                  Text(
                    ...
                    style: const TextStyle(
                      color: _AgriculturalPoliciesTabState._textMuted,
                      fontSize: 12,
                    ),
                  ),
                ],
            ...
            _MiniPill(
              label: '$slabs slabs',
              color: _AgriculturalPoliciesTabState._primary,
            ),
            const SizedBox(width: 8),
...
class _GeneralPolicyDetailView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      backgroundColor: _AgriculturalPoliciesTabState._bg,
      body: SafeArea(
        child: Column(
          children: [
            Container(
                ...
                children: [
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        Text(
                          (data['planName'] ?? 'Agricultural Policy')
                              .toString(),
                          style: const TextStyle(
                            color: _AgriculturalPoliciesTabState._textMain,
                            fontSize: 18,
                  ...
                  TextButton.icon(
                    ...
                    style: TextButton.styleFrom(
                      foregroundColor: _AgriculturalPoliciesTabState._red,
                    ),
                  ),
                ],
              ),
            ...
            const Divider(
              height: 1,
              color: _AgriculturalPoliciesTabState._border,
            ),
            Expanded(
              child: ListView(
                padding: const EdgeInsets.all(20),
  ...
  Widget _slabGroup(dynamic group) {
    ...
    if (slabs is! List || slabs.isEmpty) {
      return const Text(
        'No slabs found.',
        style: TextStyle(color: _AgriculturalPoliciesTabState._textMuted),
      );
    }
    return SingleChildScrollView(
      ...
      child: DataTable(
        headingRowColor: WidgetStatePropertyAll(
          _AgriculturalPoliciesTabState._primary.withValues(alpha: 0.06),
        ),
        columns: const [
  ...
  Future<void> _delete(BuildContext context) async {
      ...
      builder: (ctx) => AlertDialog(
        ...
        actions: [
          ...
          ElevatedButton(
            ...
            style: ElevatedButton.styleFrom(
              backgroundColor: _AgriculturalPoliciesTabState._red,
              foregroundColor: Colors.white,
            ),
    ...
    final data = doc.data();
    final deletedPlanName = (data['planName'] ?? 'Agricultural Policy')
        .toString();
    await FirebaseFirestore.instance
        .collection('agricultural_policies')
        .doc(doc.id)
    ...
    if (context.mounted) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          ...
          backgroundColor: _AgriculturalPoliciesTabState._primary,
        ),
      );
      onDeleted();
    }
      ...
      child: Row(
        children: [
          Container(
            ...
            height: 38,
            decoration: BoxDecoration(
              color: _AgriculturalPoliciesTabState._accent.withValues(
                alpha: 0.1,
              ),
            ...
            child: Icon(
              icon,
              color: _AgriculturalPoliciesTabState._accent,
              size: 20,
            ),
          ),
          const SizedBox(width: 12),
